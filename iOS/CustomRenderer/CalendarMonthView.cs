...
namespace MvvmTest.iOS.CustomRenderer
{
    public class CalendarMonthView: UIView
    {
        ...
        /// The box height
        /// </summary>
        public int BoxHeight = 44;

        /// <summary>
        /// The box width
        /// </summary>
        public int BoxWidth = 60;
        ...
        {
            _leftArrow = new CalendarArrowView(new CGRect(55, 9, 18, 22)) { Color = StyleDescriptor.TitleForegroundColor };
            ...
            _rightArrow = new CalendarArrowView(new CGRect(250, 9, 18, 22))
            {
                Color =
        ...
        private void DrawMonthLabel(CGRect rect)
        {
            ...
            DrawCenteredString(
                (NSString)CurrentMonthYear.ToString("MMM yyyy"),
                StyleDescriptor.TitleForegroundColor,
                r,
